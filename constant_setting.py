...
code_command_dict = {'': {'function': '', 'widget': ''},
                    ...
                    '鼠标操作-点击':{'function':'instruct_mouse.mouse_click(button=button,clicks=clicks,interval=interval)','widget':'command_widget_mouse_click'},
                    '鼠标操作-按下(不释放)':{'function':'instruct_mouse.mouse_down(button=button)','widget':'command_widget_mouse_down'},
                    '鼠标操作-释放':{'function':'instruct_mouse.mouse_up(button=button)','widget':'command_widget_mouse_up'},
                    '鼠标操作-滚动滚轮':{'function':'instruct_mouse.mouse_scroll(distance=distance)','widget':'command_widget_mouse_scroll'},
